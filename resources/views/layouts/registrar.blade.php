                ...
                <ul class="navbar-nav ms-auto align-items-md-center gap-2">
                    <li class="nav-item">
                        <span class="nav-link text-white d-flex align-items-center gap-1">
                            <i class="bi bi-person-badge-fill text-white-50"></i>
                            <span class="fw-semibold text-white">{{ Auth::user()?->name ?? 'Guest' }}</span>
                            <span class="badge bg-light text-dark text-uppercase ms-1" style="font-size:0.7rem;">Registrar</span>
                        </span>
                    </li>
                    <li class="nav-item">
        ...
        <aside class="sidebar d-none d-md-block">
            ...
            <nav class="nav flex-column gap-1">
                <a href="{{ route('registrar.showDashboard') }}"
                   class="sidebar-link {{ request()->routeIs('registrar.showDashboard') ? 'active' : '' }}">
                ...
                <a href="{{ route('registrar.showStudents') }}"
                   class="sidebar-link {{ request()->routeIs('registrar.showStudents') || request()->routeIs('registrar.showStudent') ? 'active' : '' }}">
                    <i class="bi bi-people-fill"></i> Students
                </a>
                <a href="{{ route('registrar.sections.showSections') }}"
                   class="sidebar-link {{ request()->routeIs('registrar.sections.*') ? 'active' : '' }}">
                    <i class="bi bi-collection"></i> Sections
                </a>
                <a href="{{ route('registrar.subjects.showSubjects') }}"
                   class="sidebar-link {{ request()->routeIs('registrar.subjects.*') ? 'active' : '' }}">
