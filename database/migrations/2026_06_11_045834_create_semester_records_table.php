...
return new class extends Migration
{
    ...
    {
        // One GPA record per student per semester. Created/updated during grade
        // encoding, locked when the registrar finalizes the semester.
        Schema::create('semester_records', function (Blueprint $table) {
            ...
            $table->boolean('is_locked')->default(false); // true after finalization
            $table->timestamps();
